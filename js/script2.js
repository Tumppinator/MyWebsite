...
class Sketch {
  constructor() {
    ...
    this.camera.position.set(0, 4.95, 6);
  ...
  init() {
    this.addCanvas();
    // const text = document.body.createTextNode("Welcome to My channel");
    // this.addVRButton();
  ...
  addElements() {
    ...
    gltfLoader.load("../model2.glb", (tiltData) => {
